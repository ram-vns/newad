...
<?php 
  ...
  $sql = "SELECT 
    ...
    $sql = "SELECT id ,SUBSTRING(adname,5,18) as Commercial,TIMESTAMPDIFF(SECOND,adstart,adend) AS Duration,greatest(adstartusercount,adendadusercount) As UserCount,adstart As StartTime
      FROM adhistory  ";
  ##  *** set needed options
  $debug_mode = false;
  $messaging = true;
  ...
  ##  *** set caption
  $dgrid->setCaption('Commercial Report');
  //
